...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "plataforma@inspiratoria.org")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "")
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "Inspiratoria <plataforma@inspiratoria.org>")

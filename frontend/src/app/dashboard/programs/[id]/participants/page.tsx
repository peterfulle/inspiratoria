 ...
 *
 * La gestión de participantes vive en el tab "Participantes" de
 * /studio/[slug]/program/[programId] — esta ruta legacy solo reenvía ahí.
 */
export default async function ProgramParticipantsRedirect({ params }: { params: { id: string } }) {
  ...
  if (slug) {
    redirect(`/studio/${slug}/program/${params.id}?tab=participantes`);
  }

 ...
 *
 * Los reportes del programa viven en el tab "Reportes" de
 * /studio/[slug]/program/[programId] — esta ruta legacy solo reenvía ahí.
 */
export default async function ProgramReportsRedirect({ params }: { params: { id: string } }) {
  ...
  if (slug) {
    redirect(`/studio/${slug}/program/${params.id}?tab=reportes`);
  }
